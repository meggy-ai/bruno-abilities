...
class DateTimeParameter(BaseModel):
    ...
    allow_past: bool = Field(True, description="Allow past dates")
    allow_future: bool = Field(True, description="Allow future dates")
...
class DurationParameter(BaseModel):
    ...
    min_seconds: Optional[float] = Field(None, description="Minimum duration in seconds")
    max_seconds: Optional[float] = Field(None, description="Maximum duration in seconds")
...
class ArrayParameter(BaseModel):
    ...
    min_items: Optional[int] = Field(None, description="Minimum number of items")
...
class ObjectParameter(BaseModel):
    ...
    required_keys: Optional[List[str]] = Field(None, description="Required keys")
