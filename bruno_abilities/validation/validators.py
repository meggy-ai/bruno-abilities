...
class ValidationError(Exception):
    ...
    def __init__(self, message: str, parameter: Optional[str] = None, value: Any = None):
...
def validate_duration(value: Any, min_seconds: Optional[float] = None, max_seconds: Optional[float] = None) -> timedelta:
    """
...
def validate_url(value: Any, allowed_schemes: Optional[list] = None) -> str:
    """
